...
const dataService:DataService<RespuestaPosiblePregunta> = new DataService("respuestas_posibles_has_preguntas");
export const RespuestaPosiblePreguntaService = {
    ...
    async eliminar(req: Request, res: Response) {
        try {
            ...
            res.status(200).json({ message: "Respuesta Posible eliminada correctamente" });
        } catch (error) {
